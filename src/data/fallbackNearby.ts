...
export const fallbackNearbyResources: FoodResource[] = [
  {
    ...
    website:
      "https://www.google.com/maps/search/?api=1&query=Saigon+Sandwich+San+Francisco",
    phone: null,
  ...
  },
  {
    ...
    eligibility: "Open to the public",
    website:
      "https://www.google.com/maps/search/?api=1&query=The+Market+1355+Market+Street+San+Francisco",
    phone: null,
    lastVerified: "2026-06-08",
    lat: 37.7767,
    lng: -122.4164,
  ...
  },
  {
    ...
    eligibility: "Open to the public",
    website:
      "https://www.google.com/maps/search/?api=1&query=Cafe+International+San+Francisco",
    phone: null,
    lastVerified: "2026-06-08",
    lat: 37.7723,
    lng: -122.4308,
